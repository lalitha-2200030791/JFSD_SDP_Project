...
<head>
    ...
    <style>
        ...
        /* Ensures content starts after header */
        .container {
            max-width: 800px;
            margin: 20px auto;
            ...
            clear: both; /* Clears any float issues from header */
        }
        ...
        .write-blog-btn:hover {
            background-color: #5a00cc; /* Darker shade on hover */
        }
    </style>
</head>
<body>
    <div class="container">
        <a href="write-blog.jsp" class="write-blog-btn">+ Write a Blog</a> <!-- Button to Write a Blog -->
        ...
        <div class="blog-posts">
            ...
            <div class="post">
                ...
                <div class="post-header">
                    <div class="user-profile">
                        <img src="images/user.png" alt="User Profile Picture"> <!-- Replace with the actual profile picture -->
            ...
            <div class="post">
                ...
                <div class="post-header">
                    <div class="user-profile">
                        <img src="images/user.png" alt="User Profile Picture"> <!-- Replace with actual profile picture -->
